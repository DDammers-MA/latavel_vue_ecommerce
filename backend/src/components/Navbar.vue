...
<button @click="emit('toggle-sidebar')" class="flex items-center justify-center rounded w-8 h-8 text-indigo-700 transition-colors hover:bg-black/10">
  <MenuIcon class="w-8"/>
</button>
  ...
  <Menu as="div" class="relative inline-block text-left">
      <div>
        ...
        >
          <img class="rounded-full w-8 mr-2" src="https://randomuser.me/api/portraits/men/88.jpg" alt="">
...
import { Menu, MenuButton, MenuItems, MenuItem } from '@headlessui/vue'
  import { ChevronDownIcon, MenuIcon, LogoutIcon, UserIcon } from '@heroicons/vue/solid'
