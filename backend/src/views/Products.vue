...
import { PRODUCTS_PER_PAGE } from "../constants";
  ...
  function imageError(product) {
    console.error('Failed to load image for product:', product);
    // Optionally handle the error (e.g., set a default image or show a placeholder)
  }
